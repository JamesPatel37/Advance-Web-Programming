...
<h3>Add new department</h3>
    	<form action= "addDepartment.html" method="post" class="form-inline text-left"> 

		    <div class="form-group">
          		<label for="department"> Department Name </label>
          		<input type="text" class="form-control" name="department" id="department" placeholder="Enter new department">
        	</div> <br/>
...
<h3>Add new Program</h3>
		...
		<form action= "addProgram.html" method="post" class="form-inline text-left"> 
        	...
        	<div class="form-group">
          		...
          		<input type="text" class="form-control" name="program" id="program" placeholder="Enter new program">
        	</div> <br/>
