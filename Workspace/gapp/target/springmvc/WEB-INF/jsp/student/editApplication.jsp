...
<table class="table table-striped table-bordered table-hover">
	...
	<c:forEach items="${application}" var="app" >
		<c:if test="${app.userId.id == student.id}">
			...
			<table class="table table-striped table-bordered table-hover">
				<tr><td colspan="2"> <h3><a href="editApplication2.html?appId=${app.id}&studentId=${student.id}" ><!--  onclick="document.getElementById('foo').submit(); return false;" --> Edit Application [${count}]</a></h3>	</td></tr> 
				...
				<tr><td><b>Transcript:</b></td>   <td><a href= "#"> View transcript </a></td></tr>
...
<%-- 		<form id="foo" method="get" action="editApplication2.html">
